        ...
        <?php while ($row = mysqli_fetch_array($query)): ?>
            <div class="card" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <p class="card-text"><?= $row['edad'] ?></p>
                    <a href="updateForm/update.php?idAlumnos=<?= $row['idAlumnos'] ?>" class="btn btn-secondary">Editar</a>
    ...
    <div class="container mt-5">
        ...
        <form action="CRUD/insert_project.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombreAlumnos" name="nombreAlumnos" placeholder="Nombre">
            </div>
            <div class="form-group">
